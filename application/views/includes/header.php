...
<head>
    ...
    <title>ApuMondal || Personal Portfolio</title>
    <meta name="robots" content="noindex, follow">
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url(); ?>assets/images/am_icon.ico">
    <!-- CSS 
    ============================================ -->
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/vendor/aos.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/plugins/feature.css">
    <!-- Style css -->
                ...
                <div class="header-left">
                    <div class="logo">
                        <a href="<?php echo base_url(); ?>">
                            <img src="<?php echo base_url(); ?>assets/images/logo/apu_logo.png" alt="logo">
                        </a>
                    </div>
                </div>
            </div>
